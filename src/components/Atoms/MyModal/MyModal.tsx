...
const MyModal: FC<MyModalProps> = ({
  ...
  return (
    <Modal dismissible {...modalProps} className={twMerge(['dark:bg-bg-dark-base', modalProps?.className])}>
      <Modal.Header
        {...headerProps}
        className={twMerge(['border-none px-4 pt-4 dark:border-gray-700', headerProps?.className])}>
      ...
      <Modal.Footer
        {...footerProps}
        className={twMerge(['pb-t border-none px-4 pt-0  dark:border-gray-700', footerProps?.className])}>
