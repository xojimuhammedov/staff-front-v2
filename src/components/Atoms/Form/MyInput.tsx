...
const MyInput = forwardRef((props: FormInputProps, ref: FormInputRef) => {
  const {
    error = false,
    fullWidth = true,
    size = 'base',
  ...
  return (
    <div className={twMerge(fullWidth && fullWidthStyles, rootClassName)}>
      {label && (
        <label
          className={twMerge([
            'relative mb-1.5 inline-block text-c-m-p font-medium text-text-base  dark:text-text-title-dark',
