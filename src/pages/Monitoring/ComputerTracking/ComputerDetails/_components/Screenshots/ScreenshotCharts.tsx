...
const ScreenshotCharts = ({ user }: { user?: any }) => {
    ...
    const { data, isLoading } = useGetAllQuery<any>({
        key: KEYS.getScreenShot + '_charts',
        ...
        if (data?.data) {
            data.data.forEach((item: any) => {
                ...
                if (map.has(date)) {
                    ...
                    // if no range provided, just add the date
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div className="rounded-md border border-gray-200 dark:border-neutral-700 bg-white dark:bg-[#1a1c23] shadow-sm overflow-hidden">
                <div className="p-4 border-b border-gray-100 dark:border-neutral-800">
                    <h3 className="text-sm font-semibold text-gray-900 dark:text-white">{t('Daily Activity')}</h3>
                </div>
                <div className="p-4">
                    <div className="h-48">
            ...
            <div className="rounded-md border border-gray-200 dark:border-neutral-700 bg-white dark:bg-[#1a1c23] shadow-sm overflow-hidden">
                <div className="p-4 border-b border-gray-100 dark:border-neutral-800">
                    <h3 className="text-sm font-semibold text-gray-900 dark:text-white">{t('Process Distribution')}</h3>
                </div>
                <div className="p-4">
                    <div className="h-48">
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={processStats} layout="vertical" margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                                ...
                                />
                                <Tooltip content={<CustomTooltip t={t} />} />
                                <Bar dataKey="count" name={t('Screenshots')} fill="#10B981" radius={[0, 4, 4, 0]} barSize={15} />
                            </BarChart>
                        </ResponsiveContainer>
                    </div>
                </div>
...
export default ScreenshotCharts;
