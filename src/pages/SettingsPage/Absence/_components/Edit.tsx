...
const Edit = ({ refetch, setOpen, typeId }: any) => {
    ...
    const {
        ...
        defaultValues: useMemo(() => {
            return {
                shortLetterEng: get(getOne, 'data.shortLetterEng'),
                shortLetterRu: get(getOne, 'data.shortLetterRu'),
                shortLetterUz: get(getOne, 'data.shortLetterUz'),
                descriptionEng: get(getOne, 'data.descriptionEng'),
                descriptionRu: get(getOne, 'data.descriptionRu'),
                descriptionUz: get(getOne, 'data.descriptionUz'),
