...
const ViewPage = () => {
  ...
  const isValidSubDepartmentSetting =
    ...
    (currentSetting === 'subdepartmentInfo' || currentSetting === 'sub_employee_list');
    ...
    <PageContentWrapper>
      <div className="flex items-center justify-between">
        ...
        <MyButton
          ...
          startIcon={<ArrowLeft />}
          className={`text-sm w-[230px] bg-white text-gray-800 border border-gray-300 hover:bg-gray-100 dark:bg-gray-800 dark:text-gray-100 dark:border-gray-700 dark:hover:bg-gray-700 [&_svg]:stroke-gray-600 dark:[&_svg]:stroke-gray-300`}
        >
